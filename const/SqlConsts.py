...
stock_history_insert_sql = 'INSERT INTO stock_history(symbol,name,current,percent,amplitude,amount,volume_ratio,current_year_percent,turnover_rate,market_capital,date) VALUES(%s, %s, %s, %s, %s, %s,%s, %s, %s, %s,%s)'
